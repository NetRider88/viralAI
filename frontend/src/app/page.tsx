    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="https://ai-it.io/blog" target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:text-primary transition-colors">
              Blog
            </Link>
          </nav>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
          From Keyword to Viral Post
          <br />
          in 60 Seconds
        </h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Research keywords, generate platform-optimized content, and track performance—all powered by AI.
        </p>
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Powerful features to create viral content
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AnswerThePublic-style keyword discovery with platform breakdown
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create platform-optimized content with the latest AI models
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI-generated images with the latest AI models or custom uploads
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Automated video content creation for TikTok & Reels
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track clicks, conversions, and ROI with custom short links
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                One content, multiple platforms—automatically adapted
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
        ...
        <Card className="bg-primary text-primary-foreground">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-primary-foreground/80 text-lg">
              Join thousands of creators using AI to create viral content
            </CardDescription>
          </CardHeader>
      ...
      <section id="use-cases" className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Trusted by content creators, marketers, and agencies
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Generate engaging content for multiple platforms in minutes, not hours.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Social Media Managers</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Plan and create content calendars with AI-powered insights and automation.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Scale content production for multiple clients with brand-specific guidelines.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Compete with big brands using professional AI-generated content on a budget.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      {/* About Section */}
      <section id="about" className="container mx-auto px-4 py-20 bg-muted/50 rounded-3xl mb-20">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">About VIRAL.AI</h2>
          <p className="text-lg text-muted-foreground mb-6">
            VIRAL.AI is a product of <Link href="https://ai-it.io" target="_blank" className="text-primary hover:underline font-semibold">AI-IT.io</Link>, 
            a leading AI solutions provider dedicated to empowering businesses and creators with cutting-edge artificial intelligence technology.
          </p>
          <p className="text-lg text-muted-foreground mb-8">
            Our mission is to democratize content creation by making professional-grade AI tools accessible to everyone, 
            from individual creators to large enterprises.
          </p>
          <Link href="https://ai-it.io" target="_blank">
            <Button size="lg" variant="outline">
              Learn More About AI-IT.io <ArrowRight className="h-4 w-4 ml-2" />
            </Button>
          </Link>
        </div>
      </section>
